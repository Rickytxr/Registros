...
public class ProfessorControler {
    ...
    public Button registroProfessor;
    @FXML
    ...
    public void RegistroProfessor(){
        ...
        String insertFiels = "INSERT INTO registroprofessor(nome,apelido,Username,dataNascimento,numerotelefone,email,password) VALUES ('";
